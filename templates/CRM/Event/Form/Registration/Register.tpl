...
<div class="eventsreg-container" id="eventsreg-main">
    ...
    <div class="crm-event-id-{$event.id} crm-block crm-event-register-form-block">
        ...
        <div class="eventsreg-block" id="eventsreg-pre">
            {* open div class .eventsreg-title *}
            <div class="eventsreg-title"><h2>{ts domain='be.ctrl.eventsreg'}Your personal information{/ts}</h2>
            </div>
            {* open div class .eventsreg-content *}
        ...
        {if $customPost}
            ...
            <div class="eventsreg-block" id="eventsreg-post">
                {* open div class .eventsreg-title *}
                <div class="eventsreg-title"><h2>{ts domain='be.ctrl.eventsreg'}Your additional data{/ts}</h2></div>
                {* open div class .eventsreg-content *}
                <div class="eventsreg-content">
                    <div class="crm-public-form-item crm-section custom_pre-section">
